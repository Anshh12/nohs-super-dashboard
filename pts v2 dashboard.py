...
if not uploaded:
    ...
    st.info("📁 Upload `NorthDelhiHouseholdL_DATA_LABELS_*.csv` to unlock all 9 analysis tabs.")
    st.markdown("""
#### What you'll get
...
tabs = st.tabs([
    ...
    "👨‍👩‍👧 Demographics", "🎯 Sampling", "📍 GPS & Tablet", "🔍 Data Quality", "🔎 Drill-down",
])
