...
# Initialize session state for recorded examiners
...
# Button to reset to default (exclude current duplicate examiners)
...
# ─── COMPUTE MASKS ───
# Duplicate mask: empty (if included) OR selected examiner numbers
...
# Recorded mask: examiner number in selected recorded examiners AND NOT duplicate
...
# Warn if overlap: examiner numbers selected in both recorded and duplicate
