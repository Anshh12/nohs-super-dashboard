...
def get_unmatched(pt, other_pt, keys):
    ...
    # Build column list without duplicates (record_id is always included, but only once)
...
if common_count == 0:
    st.error("⚠️ No common participants found. Try adjusting matching parameters.")
